  ...
  return (
    <footer className="v3-footer">
          ...
          <div className="v3-col">
            <Link href="/" className="v3-logo">
              <div className="v3-logo-icon">
                {/* Зафиксировали размеры 18x18 для защиты от растягивания */}
      ...
      <style jsx>{`
        ...
        .v3-links :global(a), .v3-links :global(.btn-reset) {
          font-size: 13px !important;
          color: #475569 !important;
          text-decoration: none !important;
        ...
        .v3-links :global(a::after), .v3-links :global(.btn-reset::after) {
          content: '' !important;
        ...
        .v3-links :global(a:hover), .v3-links :global(.btn-reset:hover) {
          color: #007a7c !important;
        }
        .v3-links :global(a:hover::after), .v3-links :global(.btn-reset:hover::after) {
