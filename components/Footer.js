    ...
    <footer className="v3-footer">
      <div className="v3-container">
        <div className="v3-grid">
          ...
          <div className="v3-col">
            <h4 class="v3-title">Gizlilik ve Kullanım</h4>
            <ul className="v3-links">
          ...
          <div className="v3-col">
            ...
            <div className="v3-contacts">
              ...
              <a href="mailto:olesyav03@mail.ru" className="v3-contact-item">
                <svg className="v3-contact-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg>
