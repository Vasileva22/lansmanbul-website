      ...
      <div className="v3-container">
          ...
          <div className="v3-col">
            <Link href="/" className="v3-logo">
              <div className="v3-logo-icon">
                {/* Добавили жесткие размеры 18x18 для защиты от растягивания */}
          ...
          <div className="v3-col">
            ...
            <div className="v3-contacts">
              <a href="tel:+905459418536" className="v3-contact-item">
                {/* Зафиксировали размеры 15x15 */}
                <svg className="v3-contact-icon" viewBox="0 0 24 24" width="15" height="15" fill="none" stroke="currentColor" strokeWidth="2">
              ...
              <a href="https://wa.me/905459418536" target="_blank" rel="noopener noreferrer" className="v3-wa-button">
                {/* Зафиксировали размеры 16x16 */}
                <svg className="v3-wa-icon" viewBox="0 0 24 24" width="16" height="16">
        ...
        <div className="v3-bottom">
          <p className="v3-disclaimer">
            © 2026 lansmanbul.com | Tüm Hakları Saklıdır. lansmanbul bir emlak bilgi platformudur. Web sitemizde yer alan bilgiler bilgilendirme amaçlıdır; yatırım tavsiyesi veya resmi teklif niteliği taşımaz. Fiyat и proje bilgilerinde değişiklik yapma hakkı saklıdır.
          </p>
        </div>
      </div>
